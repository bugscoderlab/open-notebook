...
| T9 Analytics permissions + mode UI | 2026-09-17 22:10 | 2026-09-17 23:00 | ~50 min | see session panel | Bypass deleted (ADR-014), AN-010 injection refusal, query-log ownership, migration 30, Analytics mode UI + 14 locales; full AN matrix live-verified; 1016 backend + 224 frontend tests green; issue #10 closed |
