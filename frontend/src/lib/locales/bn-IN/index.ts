...
export const bnIN = {
  ...
  auth: {
    ...
    migrationPending: "Content migration is in progress — member sign-in is temporarily disabled. Please contact your administrator.",
    signingIn: "সাইন ইন করা হচ্ছে...",
    signIn: "সাইন ইন",
    devAccountsTitle: "ডেভ অ্যাকাউন্ট (শুধু ডেভের জন্য)",
    devAccountsHint: "ফর্ম পূরণ করতে একটি অ্যাকাউন্টে ক্লিক করুন, তারপর সাইন ইন চাপুন",
  ...
  users: {
    eyebrow: "প্রশাসন",
    description: "মানুষকে আমন্ত্রণ করুন, তাদের টিম নির্ধারণ করুন এবং অ্যাকাউন্টের অবস্থা নিয়ন্ত্রণ করুন।",
    invite: "ব্যবহারকারী আমন্ত্রণ করুন",
    statTotal: "মোট ব্যবহারকারী",
    statActive: "সক্রিয়",
    statInvited: "মুলতুবি আমন্ত্রণ",
    statAllAccess: "সম্পূর্ণ অ্যাক্সেস ব্যবহারকারী",
    searchPlaceholder: "নাম বা ইমেইল দিয়ে খুঁজুন…",
    filterAllTeams: "সব টিম",
    filterAllStatuses: "সব স্থিতি",
    colUser: "ব্যবহারকারী",
    colTeam: "টিম",
    colRole: "ভূমিকা",
    colAccess: "অ্যাক্সেস",
    colStatus: "স্থিতি",
    colLastActive: "সর্বশেষ সক্রিয়",
    empty: "কোনো ব্যবহারকারী ফিল্টারের সাথে মেলে না।",
    edit: "সম্পাদনা",
    accessAll: "সব টিম",
    accessTeamCompany: "{{team}} + কোম্পানি",
    lastActiveNow: "এখনই",
    lastActiveNever: "কখনো না",
    lastActiveMinutes: "{{count}} মিনিট আগে",
    lastActiveHours: "{{count}} ঘণ্টা আগে",
    lastActiveDays: "{{count}} দিন আগে",
    inviteDialogTitle: "ব্যবহারকারী আমন্ত্রণ করুন",
    inviteDialogDesc: "তারা আপনার দেওয়া অস্থায়ী পাসওয়ার্ড দিয়ে সাইন-ইন করবেন। কোনো ইমেইল পাঠানো হয় না।",
    emailLabel: "ইমেইল",
    displayNameLabel: "প্রদর্শিত নাম",
    teamLabel: "টিম",
    teamPlaceholder: "একটি টিম নির্বাচন করুন",
    roleLabel: "ভূমিকা",
    statusLabel: "স্থিতি",
    tempPasswordLabel: "অস্থায়ী পাসওয়ার্ড",
    tempPasswordPlaceholder: "কমপক্ষে ৮ অক্ষর",
    tempPasswordHint: "কমপক্ষে ৮ অক্ষর। ব্যবহারকারীর সাথে শেয়ার করুন — এটি কখনোই ইমেইলে পাঠানো হয় না।",
    inviteDialogSubmit: "আমন্ত্রণ তৈরি করুন",
    inviteSuccess: "আমন্ত্রণ তৈরি হয়েছে — {{name}}-এর সাথে অস্থায়ী পাসওয়ার্ড শেয়ার করুন।",
    editDialogTitle: "ব্যবহারকারী সম্পাদনা",
    updateSuccess: "ব্যবহারকারী আপডেট হয়েছে",
    disableHint: "নিষ্ক্রিয় করলে ব্যবহারকারীর সেশন তাৎক্ষণিক বন্ধ হবে এবং ভবিষ্যৎ সাইন-ইন ব্লক হবে।",
    resend: "পুনরায় পাঠান",
    resendDialogTitle: "আমন্ত্রণ পুনরায় পাঠান",
    resendDialogDesc: "একটি নতুন অস্থায়ী পাসওয়ার্ড সেট করুন এবং {{name}}-এর সাথে শেয়ার করুন। কোনো ইমেইল পাঠানো হয় না।",
    resendDialogSubmit: "আমন্ত্রণ পাসওয়ার্ড রিসেট করুন",
    role: {
      member: "সদস্য",
      team_manager: "টিম ম্যানেজার",
      ceo: "CEO",
      admin: "অ্যাডমিন",
    },
    status: {
  ...
  teams: {
    eyebrow: "প্রশাসন",
    description: "বিভাগ তৈরি করুন এবং তাদের সদস্যরা কোন নোটবই দেখতে পারবেন তা নিয়ন্ত্রণ করুন।",
    create: "টিম তৈরি করুন",
    inheritedTitle: "টিম অ্যাক্সেস উত্তরাধিকারসূত্রে পাওয়া যায়",
    inheritedDesc: "সদস্যরা স্বয়ংক্রিয়ভাবে নিজেদের টিমের নোটবই এবং কোম্পানির শেয়ার্ড কনটেন্ট দেখেন। CEO এবং অ্যাডমিনরা সবকিছুতে অ্যাক্সেস পান।",
    archivedBadge: "আর্কাইভ করা হয়েছে",
    edit: "সম্পাদনা",
    membersNotebooks: "{{members}} জন সদস্য · {{notebooks}}টি নোটবই",
    managerLabel: "ম্যানেজার: {{name}}",
    noManager: "কোনো ম্যানেজার নেই",
    empty: "এখনো কোনো টিম নেই।",
    createDialogTitle: "টিম তৈরি করুন",
    createDialogDesc: "স্লাগ পারমিশন এবং কনটেন্ট শ্রেণীবিভাগে টিমকে চিহ্নিত করে।",
    editDialogTitle: "টিম সম্পাদনা",
    editDialogDesc: "পরিবর্তনগুলো তাৎক্ষণিক কার্যকর হয়।",
    slugLabel: "স্লাগ",
    slugPlaceholder: "যেমন legal",
    slugHint: "ছোট হাতের অক্ষর, সংখ্যা, ড্যাশ এবং আন্ডারস্কোর। পরে পরিবর্তন করা যাবে না।",
    nameLabel: "নাম",
    descriptionLabel: "বিবরণ",
    managerFieldLabel: "টিম ম্যানেজার",
    activeLabel: "টিম সক্রিয়",
    createDialogSubmit: "টিম তৈরি করুন",
    createSuccess: "টিম তৈরি হয়েছে",
    updateSuccess: "টিম আপডেট হয়েছে",
  },
  migration: {
    eyebrow: "Administration",
    description: "Classify existing notebooks and sources into teams before members sign in. The pass matches filename tokens (hr, finance, executive, company_shared) and defaults unclassified content to Company Shared.",
    runAction: "Run classification",
    runSuccess: "Classified {{sources}} sources and {{notebooks}} notebooks ({{flagged}} flagged).",
    completedTitle: "Classification complete",
    completedDesc: "All existing content is classified. Member sign-in is enabled.",
    pendingTitle: "Classification pending",
    pendingDesc: "Member sign-in stays blocked until the pass completes and every flagged item is resolved.",
    flaggedSources: "Flagged sources",
    flaggedNotebooks: "Flagged notebooks",
    emptySection: "Nothing to resolve here.",
    assignTeamLabel: "Team",
    assignTeamPlaceholder: "Select a team",
    assignVisibilityLabel: "Visibility",
    visibilityTeam: "Team",
    visibilityCompanyShared: "Company Shared",
    assignAction: "Assign",
    assignSuccess: "Item assigned to {{team}}.",
    linkedTeams: "Linked teams: {{teams}}",
    nothingFlagged: "Nothing is flagged. Run the classification pass to finish.",
    reason: {
      ambiguous_tokens: "Ambiguous tokens",
      mixed_team_sources: "Mixed-team sources",
      cross_team_link: "Cross-team link",
    },
  },
  ...
  sources: {
    ...
    cannotLinkAcrossTeams: "অন্য দলের উৎসগুলি এই নোটবুকে যোগ করা যাবে না।",
    hiddenOtherTeamSources: "{{count}} টি উৎস লুকানো হয়েছে কারণ সেগুলি এই নোটবুকের চেয়ে ভিন্ন দলের।",
  ...
  home: {
    welcomeTitle: "যা খুশি জিজ্ঞাসা করুন",
    welcomeHint: "আপনার নলেজ বেস ও ব্যবসায়িক ডেটার জন্য একটি চ্যাট — সহকারী প্রতিটি প্রশ্নের জন্য সঠিক উৎস বেছে নেয়।",
    placeholder: "আপনার ডকুমেন্ট বা ডেটা সম্পর্কে জিজ্ঞাসা করুন…",
    suggestions: "প্রস্তাবিত ফলো-আপ",
    searching: "নলেজ বেসে খুঁজছি…",
    analysing: "ব্যবসায়িক ডেটা বিশ্লেষণ করছি…",
    answerSourceKnowledge: "নলেজ",
    answerSourceAnalytics: "অ্যানালিটিক্স",
    starterHighestSpender: "এই বছর সবচেয়ে বেশি খরচ করেছেন কে?",
    starterRanking: "২০২৬ সালে মোট খরচ অনুযায়ী গ্রাহকদের সাজান",
    starterTopServices: "আমাদের শীর্ষ সেবাগুলো কী কী?",
    starterKnowledgeBase: "আমার নলেজ বেসে কোন ডকুমেন্ট আছে?",
  },
  searchPage: {
    modeKnowledge: "Knowledge",
    modeAnalytics: "Analytics",
    analyticsModeGroup: "Question mode",
    analyticsTitle: "Ask the business data",
    analyticsDesc: "Answers come from the structured sales database, filtered to the datasets your team is permitted to see.",
    analyticsQuestion: "Question",
    analyticsPlaceholder: "Try: Who is the highest spender this year?",
    analyticsIncludeRefunds: "Include refunds",
    analyticsAnalyse: "Analyse",
    analyticsAnalysing: "Analysing…",
    analyticsNoDatasets: "You don't have access to any analytics datasets. Contact an administrator if you need access.",
    analyticsError: "The analytics service could not answer. Please try again.",
    analyticsAnswerEyebrow: "Analytical answer",
    analyticsBadgeLive: "Live data · access filtered",
    analyticsBadgeDenied: "Access denied",
    analyticsBadgeNoData: "No data",
    analyticsBarsUnit: "MYR · YTD",
    analyticsViewQuery: "View query",
    analyticsFreshness: "data through {{date}}",
    analyticsRefundsChip: "refunds {{refunds}}",
    analyticsHowCalculatedTitle: "How this was calculated:",
    analyticsHowCalculated: "Aggregations over completed transactions grouped as shown, with refunded and voided rows excluded unless stated. Every query is filtered server-side to the teams you may access.",
    analyticsDatasetLabel: "Dataset",
    analyticsStatusTitle: {
      ok: "Analytical answer",
      denied: "Request refused",
      no_data: "No data for that period",
    },
    analyticsSuggestionHighestSpender: "Highest spender",
    analyticsSuggestionRanking: "Customer ranking",
    analyticsSuggestionAverageTicket: "Average ticket",
    analyticsSuggestionTopServices: "Top services",
    askAndSearch: "জিজ্ঞাসা ও অনুসন্ধান",
  ...
  podcasts: {
    templateExplainerTitle: "একটি টেমপ্লেট বেছে নিন, সোর্স বেছে নিন এবং জেনারেট চাপুন",
    templateExplainerDesc: "Deep Dive একটি সোর্স বিস্তারিতভাবে উপস্থাপন করে। Recap সাম্প্রতিক সংযোজনগুলিকে একটি নোটবুকের সাথে যুক্ত করে। জেনারেশন ব্যাকগ্রাউন্ডে সারিবদ্ধ হয় এবং কয়েক মিনিট সময় নেয়।",
