...
export const zhCN = {
  ...
  searchPage: {
    modeKnowledge: "知识",
    modeAnalytics: "分析",
    analyticsModeGroup: "提问模式",
    analyticsTitle: "询问业务数据",
    analyticsDesc: "回答来自结构化的销售数据库，并过滤为您团队有权访问的数据集。",
    analyticsQuestion: "问题",
    analyticsPlaceholder: "例如：今年消费最高的客户是谁？",
    analyticsIncludeRefunds: "包含退款",
    analyticsAnalyse: "分析",
    analyticsAnalysing: "分析中…",
    analyticsNoDatasets: "您没有任何分析数据集的访问权限。如有需要，请联系管理员。",
    analyticsError: "分析服务无法回答，请重试。",
    analyticsAnswerEyebrow: "分析回答",
    analyticsBadgeLive: "实时数据 · 已按权限过滤",
    analyticsBadgeDenied: "访问被拒绝",
    analyticsBadgeNoData: "无数据",
    analyticsBarsUnit: "MYR · 年初至今",
    analyticsViewQuery: "查看查询",
    analyticsFreshness: "数据截至 {{date}}",
    analyticsRefundsChip: "退款 {{refunds}}",
    analyticsHowCalculatedTitle: "计算方式：",
    analyticsHowCalculated: "对已完成交易按所示方式聚合，除特别说明外均排除退款和作废记录。所有查询均在服务器端按您有权访问的团队进行过滤。",
    analyticsDatasetLabel: "数据集",
    analyticsStatusTitle: {
      ok: "分析回答",
      denied: "请求被拒绝",
      no_data: "该期间没有数据",
    },
    analyticsSuggestionHighestSpender: "最高消费客户",
    analyticsSuggestionRanking: "客户排名",
    analyticsSuggestionAverageTicket: "平均客单价",
    analyticsSuggestionTopServices: "主要服务",
    askAndSearch: "提问与搜索",
    chooseAMode: "选择模式",
    askBeta: "提问 (beta)",
    search: "搜索",
