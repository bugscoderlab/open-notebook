...
export const zhCN = {
  ...
  auth: {
    ...
    migrationPending: "内容迁移正在进行中，成员登录已暂时禁用。请联系管理员。",
    signingIn: "正在登录...",
    signIn: "登录",
    devAccountsTitle: "开发账号（仅限开发）",
    devAccountsHint: "点击账号填充表单，然后按登录",
  ...
  users: {
    eyebrow: "管理",
    description: "邀请成员、分配团队并管理账号状态。",
    invite: "邀请用户",
    statTotal: "用户总数",
    statActive: "已激活",
    statInvited: "待处理邀请",
    statAllAccess: "全访问权限用户",
    ...
    edit: "编辑",
    accessAll: "所有团队",
    accessTeamCompany: "{{team}} + 公司共享",
    lastActiveNow: "刚刚",
    lastActiveNever: "从未",
    lastActiveMinutes: "{{count}} 分钟前",
    lastActiveHours: "{{count}} 小时前",
    lastActiveDays: "{{count}} 天前",
    inviteDialogTitle: "邀请用户",
    inviteDialogDesc: "用户将使用您另行共享的临时密码登录。系统不会发送任何邮件。",
    emailLabel: "邮箱",
    ...
    tempPasswordHint: "至少 8 个字符。请与用户共享——系统不会通过邮件发送。",
    inviteDialogSubmit: "创建邀请",
    inviteSuccess: "邀请已创建——请与 {{name}} 共享临时密码。",
    editDialogTitle: "编辑用户",
    updateSuccess: "用户已更新",
    disableHint: "禁用后该用户将立即退出登录，且无法再登录。",
    resend: "重发",
    resendDialogTitle: "重发邀请",
    resendDialogDesc: "设置新的临时密码并与 {{name}} 共享。系统不会发送任何邮件。",
    resendDialogSubmit: "重置邀请密码",
    role: {
      member: "成员",
      team_manager: "团队经理",
      ceo: "CEO",
  ...
  teams: {
    eyebrow: "管理",
    description: "创建部门，并控制其成员可以访问哪些笔记本。",
    create: "创建团队",
    inheritedTitle: "团队访问权限自动继承",
    inheritedDesc: "成员自动可见其所在团队的笔记本及公司共享内容。CEO 和管理员保留对所有内容的访问权限。",
    archivedBadge: "已归档",
    edit: "编辑",
    membersNotebooks: "{{members}} 名成员 · {{notebooks}} 本笔记本",
    managerLabel: "经理：{{name}}",
    noManager: "无经理",
    empty: "还没有团队。",
    createDialogTitle: "创建团队",
    createDialogDesc: "Slug 用于在权限和内容分类中标识团队。",
    editDialogTitle: "编辑团队",
    editDialogDesc: "更改将立即生效。",
    slugLabel: "Slug",
    slugPlaceholder: "例如 legal",
    slugHint: "小写字母、数字、连字符和下划线。创建后无法更改。",
    nameLabel: "名称",
    descriptionLabel: "描述",
    managerFieldLabel: "团队经理",
    activeLabel: "团队处于启用状态",
    createDialogSubmit: "创建团队",
    createSuccess: "团队已创建",
    updateSuccess: "团队已更新",
  },
  migration: {
    eyebrow: "管理",
    description: "在成员登录之前，将现有笔记本和来源分类到团队。分类过程会识别文件名中的标记（hr、finance、executive、company_shared），未分类的内容默认为 Company Shared。",
    runAction: "运行分类",
    runSuccess: "已分类 {{sources}} 个来源和 {{notebooks}} 个笔记本（{{flagged}} 个被标记）。",
    completedTitle: "分类已完成",
    completedDesc: "所有现有内容均已分类。成员登录已启用。",
    pendingTitle: "分类待处理",
    pendingDesc: "在分类完成且所有标记项目得到解决之前，成员登录将保持阻止状态。",
    flaggedSources: "被标记的来源",
    flaggedNotebooks: "被标记的笔记本",
    emptySection: "这里没有需要处理的内容。",
    assignTeamLabel: "团队",
    assignTeamPlaceholder: "选择团队",
    assignVisibilityLabel: "可见性",
    visibilityTeam: "团队",
    visibilityCompanyShared: "Company Shared",
    assignAction: "分配",
    assignSuccess: "项目已分配给 {{team}}。",
    linkedTeams: "关联团队：{{teams}}",
    nothingFlagged: "没有标记的项目。运行分类以完成。",
    reason: {
      ambiguous_tokens: "标记不明确",
      mixed_team_sources: "混合团队的来源",
      cross_team_link: "跨团队链接",
    },
  },
  ...
  sources: {
    ...
    cannotLinkAcrossTeams: "无法将其他团队的来源添加到此笔记本。",
    hiddenOtherTeamSources: "已隐藏 {{count}} 个来源，因为它们属于与此笔记本不同的团队。",
  ...
  home: {
    ...
    suggestions: "建议的追问",
    searching: "正在搜索知识库…",
    answerSourceKnowledge: "知识",
    starterHighestSpender: "今年消费最高的是谁？",
    starterRanking: "按 2026 年总消费给客户排名",
    starterTopServices: "我们的主要服务有哪些？",
    starterKnowledgeBase: "我的知识库里有哪些文档？",
  },
  searchPage: {
    askAndSearch: "提问与搜索",
    chooseAMode: "选择模式",
  ...
  podcasts: {
    templateExplainerTitle: "选择模板，选择来源，然后点击生成",
    templateExplainerDesc: "Deep Dive 详细讲解一个来源。Recap 将最新添加的内容连接到笔记本。生成在后台排队，需要几分钟。",
  ...
  settings: {
    ...
    askPipeline: "Ask 流水线",
    askPipelineDesc: "调整 Ask 流水线每个问题的模型调用开销",
    askMaxSearches: "每个问题的最大搜索次数",
    askMaxSearchesHelp: "每次搜索都会对检索到的内容块单独调用一次模型，搜索越多花费越高。3 次已能覆盖大多数问题。",
    askSearchAnswerMaxTokens: "搜索答案 Token 上限",
    askSearchAnswerMaxTokensHelp: "每条用于最终汇总的中间搜索答案的输出上限。调低可节省额度；最终答案的更大预算不受影响。",
    fileManagement: "文件管理",
  ...
  chatIntegrations: {
    title: "聊天集成",
    description: "通过 Telegram 或 WhatsApp 提问并搜索您的笔记本。",
    platforms: {
      telegram: "Telegram",
      whatsapp: "WhatsApp",
    },
    connected: "已连接",
    notConnected: "未连接",
    linkedCount: "已绑定 {{count}} 个身份",
    notConnectedDesc: "绑定您的 {{platform}} 账户以在聊天中提问",
    connect: "连接",
    manage: "管理",
    close: "关闭",
    connectTitle: "连接 {{platform}}",
    connectDesc: "您需要在手机上确认绑定——一分钟内即可完成。",
    stepSend: "打开 {{platform}}，将验证码发送给 {{bot}}：",
    stepWait: "请稍候——系统会自动确认。",
    codeExpired: "验证码已过期。重新生成一个即可——连接不受影响。",
    generateNew: "生成新验证码",
    expiresIn: "{{time}} 后过期",
    waiting: "等待确认…",
    copied: "复制验证码",
    linkedOn: "绑定于 {{date}}",
    unlink: "解除绑定",
    unlinkSuccess: "集成绑定已移除",
    linkedSuccess: "聊天账户已绑定——您可以开始提问了",
    createFailed: "无法生成验证码，请重试",
    telegramBotRef: "@open_notebook_bot",
    whatsappBotRef: "Open Notebook 号码",
    whatsappStepScan: "在 WhatsApp 中，前往 设置 → 已链接的设备 → 链接设备，扫描下方二维码",
    whatsappQrRefreshNote: "二维码会自动刷新，直至过期。",
    whatsappQrConnected: "WhatsApp 已连接——请发送下方代码以绑定您的账户。",
    whatsappQrWaiting: "正在等待网关返回配对二维码——请确认 messenger 网关正在运行。",
    whatsappLinkSelf: "这是我本人的号码——绑定到我的账户",
    whatsappRePair: "改用其他号码配对",
  },
  advanced: {
    title: "高级工具",
    desc: "面向进阶用户的调试和实用工具",
