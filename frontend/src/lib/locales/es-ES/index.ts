...
export const esES = {
  ...
  auth: {
    ...
    migrationPending: "La migración de contenido está en curso: el inicio de sesión de miembros está temporalmente desactivado. Contacta con el administrador.",
    signingIn: "Iniciando sesión...",
    signIn: "Iniciar sesión",
    devAccountsTitle: "Cuentas de desarrollo (solo desarrollo)",
    devAccountsHint: "Haz clic en una cuenta para rellenar el formulario y pulsa Iniciar sesión",
  ...
  users: {
    ...
    description: "Invita a personas, asigna su equipo y controla el estado de la cuenta.",
    invite: "Invitar usuario",
    statTotal: "Usuarios totales",
    statActive: "Activos",
    statInvited: "Invitaciones pendientes",
    statAllAccess: "Usuarios con acceso total",
    ...
    edit: "Editar",
    accessAll: "Todos los equipos",
    accessTeamCompany: "{{team}} + Empresa",
    lastActiveNow: "Ahora",
    lastActiveNever: "Nunca",
    lastActiveMinutes: "hace {{count}} min",
    lastActiveHours: "hace {{count}} h",
    lastActiveDays: "hace {{count}} d",
    inviteDialogTitle: "Invitar usuario",
    inviteDialogDesc: "Iniciarán sesión con una contraseña temporal que tú compartes con ellos por otro canal. No se envía ningún correo.",
    ...
    tempPasswordPlaceholder: "Mínimo 8 caracteres",
    tempPasswordHint: "Mínimo 8 caracteres. Compártela con el usuario: nunca se envía por correo.",
    inviteDialogSubmit: "Crear invitación",
    inviteSuccess: "Invitación creada: comparte la contraseña temporal con {{name}}.",
    editDialogTitle: "Editar usuario",
    updateSuccess: "Usuario actualizado",
    disableHint: "Al desactivar se cerrará su sesión inmediatamente y se bloquearán los inicios de sesión futuros.",
    resend: "Reenviar",
    resendDialogTitle: "Reenviar invitación",
    resendDialogDesc: "Establece una nueva contraseña temporal y compártela con {{name}}. No se envía ningún correo.",
    resendDialogSubmit: "Restablecer contraseña de invitación",
    role: {
      member: "Miembro",
  ...
  teams: {
    eyebrow: "Administración",
    description: "Crea departamentos y controla a qué cuadernos pueden acceder sus miembros.",
    create: "Crear equipo",
    inheritedTitle: "El acceso de equipo se hereda",
    inheritedDesc: "Los miembros ven automáticamente los cuadernos de su equipo más los compartidos de la empresa. El CEO y los administradores conservan acceso a todo.",
    archivedBadge: "Archivado",
    edit: "Editar",
    membersNotebooks: "{{members}} miembros · {{notebooks}} cuadernos",
    managerLabel: "Responsable: {{name}}",
    noManager: "Sin responsable",
    empty: "Aún no hay equipos.",
    createDialogTitle: "Crear equipo",
    createDialogDesc: "El slug identifica al equipo en los permisos y en la clasificación de contenidos.",
    editDialogTitle: "Editar equipo",
    editDialogDesc: "Los cambios se aplican inmediatamente.",
    slugLabel: "Slug",
    slugPlaceholder: "p. ej. legal",
    slugHint: "Letras minúsculas, números, guiones y guiones bajos. No se puede cambiar después.",
    nameLabel: "Nombre",
    descriptionLabel: "Descripción",
    managerFieldLabel: "Responsable de equipo",
    activeLabel: "El equipo está activo",
    createDialogSubmit: "Crear equipo",
    createSuccess: "Equipo creado",
    updateSuccess: "Equipo actualizado",
  },
  migration: {
    eyebrow: "Administración",
    description: "Clasifica los notebooks y fuentes existentes en equipos antes de que los miembros inicien sesión. El proceso reconoce tokens en los nombres de archivo (hr, finance, executive, company_shared) y asigna Company Shared por defecto al contenido no clasificado.",
    runAction: "Ejecutar clasificación",
    runSuccess: "{{sources}} fuentes y {{notebooks}} notebooks clasificados ({{flagged}} marcados).",
    completedTitle: "Clasificación completada",
    completedDesc: "Todo el contenido existente está clasificado. El inicio de sesión de miembros está habilitado.",
    pendingTitle: "Clasificación pendiente",
    pendingDesc: "El inicio de sesión de miembros permanece bloqueado hasta que termine el proceso y se resuelva cada elemento marcado.",
    flaggedSources: "Fuentes marcadas",
    flaggedNotebooks: "Notebooks marcados",
    emptySection: "Nada que resolver aquí.",
    assignTeamLabel: "Equipo",
    assignTeamPlaceholder: "Selecciona un equipo",
    assignVisibilityLabel: "Visibilidad",
    visibilityTeam: "Equipo",
    visibilityCompanyShared: "Company Shared",
    assignAction: "Asignar",
    assignSuccess: "Elemento asignado a {{team}}.",
    linkedTeams: "Equipos vinculados: {{teams}}",
    nothingFlagged: "Nada marcado. Ejecuta la clasificación para terminar.",
    reason: {
      ambiguous_tokens: "Tokens ambiguos",
      mixed_team_sources: "Fuentes de equipos mixtos",
      cross_team_link: "Vínculo entre equipos",
    },
  },
  ...
  sources: {
    ...
    cannotLinkAcrossTeams: "Las fuentes de otro equipo no se pueden añadir a este cuaderno.",
    hiddenOtherTeamSources: "{{count}} fuente(s) ocultas porque pertenecen a otro equipo distinto de este cuaderno.",
  ...
  home: {
    welcomeTitle: "Pregunta lo que quieras",
    welcomeHint: "Un chat para tu base de conocimientos y tus datos de negocio: el asistente elige la fuente adecuada para cada pregunta.",
    placeholder: "Pregunta sobre tus documentos o tus datos…",
    suggestions: "Posibles seguimientos",
    searching: "Buscando en la base de conocimientos…",
    analysing: "Analizando datos de negocio…",
    answerSourceKnowledge: "Conocimiento",
    answerSourceAnalytics: "Analítica",
    starterHighestSpender: "¿Quién es el que más gasta este año?",
    starterRanking: "Ordena clientes por gasto total en 2026",
    starterTopServices: "¿Cuáles son nuestros servicios principales?",
    starterKnowledgeBase: "¿Qué documentos hay en mi base de conocimientos?",
  },
  searchPage: {
    modeKnowledge: "Conocimiento",
    modeAnalytics: "Análisis",
    analyticsModeGroup: "Modo de pregunta",
    analyticsTitle: "Pregunta a los datos del negocio",
    analyticsDesc: "Las respuestas proceden de la base de ventas estructurada, filtrada por los conjuntos de datos permitidos para tu equipo.",
    analyticsQuestion: "Pregunta",
    analyticsPlaceholder: "Ej.: ¿Quién es el mayor comprador este año?",
    analyticsIncludeRefunds: "Incluir reembolsos",
    analyticsAnalyse: "Analizar",
    analyticsAnalysing: "Analizando…",
    analyticsNoDatasets: "No tienes acceso a ningún conjunto de datos analítico. Contacta con un administrador si necesitas acceso.",
    analyticsError: "El servicio de análisis no pudo responder. Inténtalo de nuevo.",
    analyticsAnswerEyebrow: "Respuesta analítica",
    analyticsBadgeLive: "Datos en vivo · acceso filtrado",
    analyticsBadgeDenied: "Acceso denegado",
    analyticsBadgeNoData: "Sin datos",
    analyticsBarsUnit: "MYR · año en curso",
    analyticsViewQuery: "Ver consulta",
    analyticsFreshness: "datos hasta el {{date}}",
    analyticsRefundsChip: "reembolsos {{refunds}}",
    analyticsHowCalculatedTitle: "Cómo se calculó:",
    analyticsHowCalculated: "Agregaciones sobre transaciones completadas agrupadas como se muestra, excluyendo reembolsos y anulaciones salvo indicación. Cada consulta se filtra en el servidor según los equipos a los que tienes acceso.",
    analyticsDatasetLabel: "Conjunto de datos",
    analyticsStatusTitle: {
      ok: "Respuesta analítica",
      denied: "Solicitud rechazada",
      no_data: "Sin datos en el período",
    },
    analyticsSuggestionHighestSpender: "Mayor comprador",
    analyticsSuggestionRanking: "Ranking de clientes",
    analyticsSuggestionAverageTicket: "Ticket medio",
    analyticsSuggestionTopServices: "Servicios principales",
    askAndSearch: "Preguntar y buscar",
  ...
  podcasts: {
    templateExplainerTitle: "Elige una plantilla, selecciona fuentes y pulsa generar",
    templateExplainerDesc: "Deep Dive recorre una fuente en detalle. Recap conecta las últimas incorporaciones a un cuaderno. La generación se encola en segundo plano y tarda unos minutos.",
