...
export const jaJP = {
  ...
  auth: {
    ...
    migrationPending: "コンテンツの移行が進行中のため、メンバーのサインインは一時的に無効化されています。管理者にお問い合わせください。",
    signingIn: "サインイン中...",
    signIn: "サインイン",
    devAccountsTitle: "開発アカウント（開発専用）",
    devAccountsHint: "アカウントをクリックしてフォームを入力し、「サインイン」を押してください",
  ...
  users: {
    eyebrow: "管理",
    description: "ユーザーを招待し、チームを割り当て、アカウントの状態を管理します。",
    invite: "ユーザーを招待",
    statTotal: "ユーザー総数",
    statActive: "アクティブ",
    statInvited: "保留中の招待",
    statAllAccess: "全アクセス権ユーザー",
    searchPlaceholder: "名前またはメールで検索…",
    filterAllTeams: "すべてのチーム",
    ...
    edit: "編集",
    accessAll: "すべてのチーム",
    accessTeamCompany: "{{team}} + 会社全体",
    lastActiveNow: "たった今",
    lastActiveNever: "なし",
    lastActiveMinutes: "{{count}} 分前",
    lastActiveHours: "{{count}} 時間前",
    lastActiveDays: "{{count}} 日前",
    inviteDialogTitle: "ユーザーを招待",
    inviteDialogDesc: "ユーザーは別途共有する仮パスワードでサインインします。メールは送信されません。",
    emailLabel: "メール",
    ...
    roleLabel: "ロール",
    statusLabel: "ステータス",
    tempPasswordLabel: "仮パスワード",
    tempPasswordPlaceholder: "8文字以上",
    tempPasswordHint: "8文字以上。ユーザーに共有してください。メールで送信されることはありません。",
    inviteDialogSubmit: "招待を作成",
    inviteSuccess: "招待を作成しました。仮パスワードを {{name}} と共有してください。",
    editDialogTitle: "ユーザーを編集",
    updateSuccess: "ユーザーを更新しました",
    disableHint: "無効にすると、そのユーザーのセッションは即座に失効し、今後のサインインもブロックされます。",
    resend: "再送",
    resendDialogTitle: "招待を再送",
    resendDialogDesc: "新しい仮パスワードを設定し、{{name}} と共有してください。メールは送信されません。",
    resendDialogSubmit: "招待パスワードをリセット",
    role: {
      member: "メンバー",
  ...
  teams: {
    eyebrow: "管理",
    description: "部署を作成し、メンバーがアクセスできるノートブックを管理します。",
    create: "チームを作成",
    inheritedTitle: "チームアクセスは継承されます",
    inheritedDesc: "メンバーは自分のチームのノートブックと会社共有のコンテンツを自動的に閲覧できます。CEOと管理者はすべてにアクセスできます。",
    archivedBadge: "アーカイブ済み",
    edit: "編集",
    membersNotebooks: "{{members}} 名のメンバー · {{notebooks}} 件のノートブック",
    managerLabel: "マネージャー: {{name}}",
    noManager: "マネージャーなし",
    empty: "チームはまだありません。",
    createDialogTitle: "チームを作成",
    createDialogDesc: "スラッグは権限とコンテンツ分類でチームを識別します。",
    editDialogTitle: "チームを編集",
    editDialogDesc: "変更は即座に適用されます。",
    slugLabel: "スラッグ",
    slugPlaceholder: "例: legal",
    slugHint: "小文字、数字、ハイフン、アンダースコア。後から変更できません。",
    nameLabel: "名前",
    descriptionLabel: "説明",
    managerFieldLabel: "チームマネージャー",
    activeLabel: "チームは有効",
    createDialogSubmit: "チームを作成",
    createSuccess: "チームを作成しました",
    updateSuccess: "チームを更新しました",
  },
  migration: {
    eyebrow: "管理",
    description: "メンバーがサインインする前に、既存のノートブックとソースをチームに分類します。分類処理はファイル名のトークン（hr、finance、executive、company_shared）を認識し、未分類のコンテンツはデフォルトで Company Shared になります。",
    runAction: "分類を実行",
    runSuccess: "{{sources}} 件のソースと {{notebooks}} 件のノートブックを分類しました（{{flagged}} 件がフラグ付き）。",
    completedTitle: "分類が完了しました",
    completedDesc: "既存のコンテンツはすべて分類されています。メンバーのサインインが有効になりました。",
    pendingTitle: "分類が保留中です",
    pendingDesc: "分類処理が完了し、すべてのフラグ付きアイテムが解決されるまで、メンバーのサインインはブロックされたままです。",
    flaggedSources: "フラグ付きソース",
    flaggedNotebooks: "フラグ付きノートブック",
    emptySection: "ここで解決するものはありません。",
    assignTeamLabel: "チーム",
    assignTeamPlaceholder: "チームを選択",
    assignVisibilityLabel: "公開範囲",
    visibilityTeam: "チーム",
    visibilityCompanyShared: "Company Shared",
    assignAction: "割り当て",
    assignSuccess: "アイテムを {{team}} に割り当てました。",
    linkedTeams: "リンクされているチーム: {{teams}}",
    nothingFlagged: "フラグ付きのアイテムはありません。分類を実行して完了してください。",
    reason: {
      ambiguous_tokens: "曖昧なトークン",
      mixed_team_sources: "複数チームのソース",
      cross_team_link: "チーム間リンク",
    },
  },
  ...
  sources: {
    ...
    cannotLinkAcrossTeams: "別のチームのソースはこのノートブックに追加できません。",
    hiddenOtherTeamSources: "{{count}} 件のソースはこのノートブックと別のチームのもののため非表示です。",
  ...
  home: {
    welcomeTitle: "何でも聞いてください",
    welcomeHint: "ナレッジベースとビジネスデータをひとつのチャットで——アシスタントが各質問に適したソースを選びます。",
    placeholder: "ドキュメントやデータについて質問してください…",
    suggestions: "おすすめのフォローアップ",
    searching: "ナレッジベースを検索中…",
    analysing: "ビジネスデータを分析中…",
    answerSourceKnowledge: "ナレッジ",
    answerSourceAnalytics: "分析",
    starterHighestSpender: "今年最も支出が多いのは誰？",
    starterRanking: "2026年の合計支出で顧客を順位付けして",
    starterTopServices: "主なサービスは何？",
    starterKnowledgeBase: "ナレッジベースにはどんなドキュメントがある？",
  },
  searchPage: {
    modeKnowledge: "ナレッジ",
    modeAnalytics: "分析",
    analyticsModeGroup: "質問モード",
    analyticsTitle: "業務データに質問する",
    analyticsDesc: "回答は構造化された販売データベースから取得され、チームがアクセスを許可されたデータセットに絞り込まれます。",
    analyticsQuestion: "質問",
    analyticsPlaceholder: "例：今年の最高顧客は誰ですか？",
    analyticsIncludeRefunds: "返金を含める",
    analyticsAnalyse: "分析",
    analyticsAnalysing: "分析中…",
    analyticsNoDatasets: "アクセスできる分析データセットがありません。必要な場合は管理者にお問い合わせください。",
    analyticsError: "分析サービスが応答できませんでした。もう一度お試しください。",
    analyticsAnswerEyebrow: "分析回答",
    analyticsBadgeLive: "ライブデータ · アクセスフィルター適用",
    analyticsBadgeDenied: "アクセスが拒否されました",
    analyticsBadgeNoData: "データなし",
    analyticsBarsUnit: "MYR · 年初来",
    analyticsViewQuery: "クエリを表示",
    analyticsFreshness: "{{date}} 時点のデータ",
    analyticsRefundsChip: "返金 {{refunds}}",
    analyticsHowCalculatedTitle: "計算方法:",
    analyticsHowCalculated: "表示どおりにグループ化された完了取引の集計で、特に記載がない限り返金・取消行は除外されます。すべてのクエリはサーバー側でアクセス可能なチームにのみフィルターされます。",
    analyticsDatasetLabel: "データセット",
    analyticsStatusTitle: {
      ok: "分析回答",
      denied: "リクエストは拒否されました",
      no_data: "対象期間にデータがありません",
    },
    analyticsSuggestionHighestSpender: "最高顧客",
    analyticsSuggestionRanking: "顧客ランキング",
    analyticsSuggestionAverageTicket: "平均単価",
    analyticsSuggestionTopServices: "主要サービス",
    askAndSearch: "質問と検索",
    chooseAMode: "モードを選択",
    askBeta: "質問（ベータ）",
    search: "検索",
  ...
  podcasts: {
    templateExplainerTitle: "テンプレートを選び、ソースを選んで生成を押してください",
    templateExplainerDesc: "Deep Dive は1つのソースを詳しく解説します。Recap はノートブックへの最新の追加をつなぎます。生成はバックグラウンドでキューに入れられ、数分かかります。",
