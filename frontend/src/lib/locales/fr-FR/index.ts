...
export const frFR = {
  ...
  auth: {
    ...
    migrationPending: "La migration du contenu est en cours — la connexion des membres est temporairement désactivée. Contactez votre administrateur.",
    signingIn: "Connexion...",
    signIn: "Se connecter",
    devAccountsTitle: "Comptes de développement (développement uniquement)",
    devAccountsHint: "Cliquez sur un compte pour remplir le formulaire, puis appuyez sur Connexion",
  ...
  users: {
    ...
    description: "Invitez des personnes, attribuez leur équipe et contrôlez le statut du compte.",
    invite: "Inviter un utilisateur",
    statTotal: "Utilisateurs au total",
    statActive: "Actifs",
    statInvited: "Invitations en attente",
    statAllAccess: "Utilisateurs à accès total",
    ...
    edit: "Modifier",
    accessAll: "Toutes les équipes",
    accessTeamCompany: "{{team}} + Entreprise",
    lastActiveNow: "Maintenant",
    lastActiveNever: "Jamais",
    lastActiveMinutes: "il y a {{count}} min",
    lastActiveHours: "il y a {{count}} h",
    lastActiveDays: "il y a {{count}} j",
    inviteDialogTitle: "Inviter un utilisateur",
    inviteDialogDesc: "La personne se connecte avec un mot de passe temporaire que vous lui transmettez par un autre canal. Aucun e-mail n'est envoyé.",
    emailLabel: "E-mail",
    ...
    tempPasswordHint: "8 caractères minimum. Partagez-le avec l'utilisateur : il n'est jamais envoyé par e-mail.",
    inviteDialogSubmit: "Créer l'invitation",
    inviteSuccess: "Invitation créée — partagez le mot de passe temporaire avec {{name}}.",
    editDialogTitle: "Modifier l'utilisateur",
    updateSuccess: "Utilisateur mis à jour",
    disableHint: "La désactivation déconnecte immédiatement l'utilisateur et bloque les futures connexions.",
    resend: "Renvoyer",
    resendDialogTitle: "Renvoyer l'invitation",
    resendDialogDesc: "Définissez un nouveau mot de passe temporaire et partagez-le avec {{name}}. Aucun e-mail n'est envoyé.",
    resendDialogSubmit: "Réinitialiser le mot de passe d'invitation",
    role: {
      member: "Membre",
  ...
  teams: {
    eyebrow: "Administration",
    description: "Créez des départements et contrôlez à quels carnets leurs membres peuvent accéder.",
    create: "Créer une équipe",
    inheritedTitle: "L'accès d'équipe est hérité",
    inheritedDesc: "Les membres voient automatiquement les carnets de leur équipe ainsi que le contenu partagé de l'entreprise. Le CEO et les administrateurs conservent l'accès à tout.",
    archivedBadge: "Archivée",
    edit: "Modifier",
    membersNotebooks: "{{members}} membres · {{notebooks}} carnets",
    managerLabel: "Responsable : {{name}}",
    noManager: "Aucun responsable",
    empty: "Aucune équipe pour le moment.",
    createDialogTitle: "Créer une équipe",
    createDialogDesc: "Le slug identifie l'équipe dans les permissions et la classification du contenu.",
    editDialogTitle: "Modifier l'équipe",
    editDialogDesc: "Les modifications s'appliquent immédiatement.",
    slugLabel: "Slug",
    slugPlaceholder: "ex. legal",
    slugHint: "Lettres minuscules, chiffres, tirets et underscores. Ne peut pas être modifié ensuite.",
    nameLabel: "Nom",
    descriptionLabel: "Description",
    managerFieldLabel: "Responsable d'équipe",
    activeLabel: "L'équipe est active",
    createDialogSubmit: "Créer l'équipe",
    createSuccess: "Équipe créée",
    updateSuccess: "Équipe mise à jour",
  },
  migration: {
    eyebrow: "Administration",
    description: "Classez les notebooks et sources existants dans les équipes avant la connexion des membres. La passe reconnaît les jetons dans les noms de fichiers (hr, finance, executive, company_shared) et attribue Company Shared par défaut au contenu non classé.",
    runAction: "Lancer la classification",
    runSuccess: "{{sources}} sources et {{notebooks}} notebooks classés ({{flagged}} signalés).",
    completedTitle: "Classification terminée",
    completedDesc: "Tout le contenu existant est classé. La connexion des membres est activée.",
    pendingTitle: "Classification en attente",
    pendingDesc: "La connexion des membres reste bloquée jusqu'à la fin de la passe et la résolution de chaque élément signalé.",
    flaggedSources: "Sources signalées",
    flaggedNotebooks: "Notebooks signalés",
    emptySection: "Rien à résoudre ici.",
    assignTeamLabel: "Équipe",
    assignTeamPlaceholder: "Sélectionnez une équipe",
    assignVisibilityLabel: "Visibilité",
    visibilityTeam: "Équipe",
    visibilityCompanyShared: "Company Shared",
    assignAction: "Attribuer",
    assignSuccess: "Élément attribué à {{team}}.",
    linkedTeams: "Équipes liées : {{teams}}",
    nothingFlagged: "Rien n'est signalé. Lancez la classification pour terminer.",
    reason: {
      ambiguous_tokens: "Jetons ambigus",
      mixed_team_sources: "Sources d'équipes mixtes",
      cross_team_link: "Lien inter-équipes",
    },
  },
  ...
  sources: {
    ...
    cannotLinkAcrossTeams: "Les sources d'une autre équipe ne peuvent pas être ajoutées à ce carnet.",
    hiddenOtherTeamSources: "{{count}} source(s) masquée(s) car elles appartiennent à une équipe différente de ce carnet.",
  ...
  home: {
    welcomeTitle: "Posez vos questions",
    welcomeHint: "Un chat pour votre base de connaissances et vos données métier — l'assistant choisit la bonne source pour chaque question.",
    placeholder: "Posez une question sur vos documents ou vos données…",
    suggestions: "Suggestions de suites",
    searching: "Recherche dans la base de connaissances…",
    analysing: "Analyse des données métier…",
    answerSourceKnowledge: "Connaissance",
    answerSourceAnalytics: "Analytique",
    starterHighestSpender: "Qui a dépensé le plus cette année ?",
    starterRanking: "Classer les clients par dépenses totales en 2026",
    starterTopServices: "Quels sont nos services principaux ?",
    starterKnowledgeBase: "Quels documents y a-t-il dans ma base de connaissances ?",
  },
  searchPage: {
    modeKnowledge: "Connaissance",
    modeAnalytics: "Analytique",
    analyticsModeGroup: "Mode de question",
    analyticsTitle: "Interrogez les données de l'entreprise",
    analyticsDesc: "Les réponses proviennent de la base de ventes structurée, filtrée selon les ensembles de données autorisés pour votre équipe.",
    analyticsQuestion: "Question",
    analyticsPlaceholder: "Ex. : Qui est le plus gros client cette année ?",
    analyticsIncludeRefunds: "Inclure les remboursements",
    analyticsAnalyse: "Analyser",
    analyticsAnalysing: "Analyse…",
    analyticsNoDatasets: "Vous n'avez accès à aucun ensemble de données analytique. Contactez un administrateur si besoin.",
    analyticsError: "Le service analytique n'a pas pu répondre. Veuillez réessayer.",
    analyticsAnswerEyebrow: "Réponse analytique",
    analyticsBadgeLive: "Données en direct · accès filtré",
    analyticsBadgeDenied: "Accès refusé",
    analyticsBadgeNoData: "Aucune donnée",
    analyticsBarsUnit: "MYR · année en cours",
    analyticsViewQuery: "Voir la requête",
    analyticsFreshness: "données jusqu'au {{date}}",
    analyticsRefundsChip: "remboursements {{refunds}}",
    analyticsHowCalculatedTitle: "Comment cela a été calculé :",
    analyticsHowCalculated: "Agrégations sur les transactions terminées, regroupées comme affiché, hors remboursements et annulations sauf mention. Chaque requête est filtrée côté serveur selon les équipes auxquelles vous avez accès.",
    analyticsDatasetLabel: "Ensemble de données",
    analyticsStatusTitle: {
      ok: "Réponse analytique",
      denied: "Demande refusée",
      no_data: "Aucune donnée sur la période",
    },
    analyticsSuggestionHighestSpender: "Plus gros client",
    analyticsSuggestionRanking: "Classement clients",
    analyticsSuggestionAverageTicket: "Panier moyen",
    analyticsSuggestionTopServices: "Services principaux",
  ...
  podcasts: {
    templateExplainerTitle: "Choisissez un modèle, sélectionnez des sources et appuyez sur générer",
    templateExplainerDesc: "Deep Dive parcourt une source en détail. Recap relie les derniers ajouts à un notebook. La génération est mise en file en arrière-plan et prend quelques minutes.",
