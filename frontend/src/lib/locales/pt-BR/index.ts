...
export const ptBR = {
  ...
  auth: {
    ...
    migrationPending: "A migração de conteúdo está em andamento — o login de membros está temporariamente desativado. Contate o administrador.",
    signingIn: "Entrando...",
    signIn: "Entrar",
    devAccountsTitle: "Contas de desenvolvimento (somente desenvolvimento)",
    devAccountsHint: "Clique em uma conta para preencher o formulário e pressione Entrar",
  ...
  users: {
    ...
    description: "Convide pessoas, atribua equipes e controle o status da conta.",
    invite: "Convidar usuário",
    statTotal: "Total de usuários",
    statActive: "Ativos",
    statInvited: "Convites pendentes",
    statAllAccess: "Usuários com acesso total",
    searchPlaceholder: "Buscar por nome ou e-mail…",
    filterAllTeams: "Todas as equipes",
    ...
    edit: "Editar",
    accessAll: "Todas as equipes",
    accessTeamCompany: "{{team}} + Empresa",
    lastActiveNow: "Agora",
    lastActiveNever: "Nunca",
    lastActiveMinutes: "há {{count}} min",
    lastActiveHours: "há {{count}} h",
    lastActiveDays: "há {{count}} d",
    inviteDialogTitle: "Convidar usuário",
    inviteDialogDesc: "A pessoa entra com uma senha temporária que você compartilha por fora. Nenhum e-mail é enviado.",
    emailLabel: "E-mail",
    ...
    tempPasswordPlaceholder: "Mínimo de 8 caracteres",
    tempPasswordHint: "Mínimo de 8 caracteres. Compartilhe com o usuário — ela nunca é enviada por e-mail.",
    inviteDialogSubmit: "Criar convite",
    inviteSuccess: "Convite criado — compartilhe a senha temporária com {{name}}.",
    editDialogTitle: "Editar usuário",
    updateSuccess: "Usuário atualizado",
    disableHint: "Desativar encerra a sessão do usuário imediatamente e bloqueia novos acessos.",
    resend: "Reenviar",
    resendDialogTitle: "Reenviar convite",
    resendDialogDesc: "Defina uma nova senha temporária e compartilhe com {{name}}. Nenhum e-mail é enviado.",
    resendDialogSubmit: "Redefinir senha do convite",
    role: {
      member: "Membro",
  ...
  teams: {
    eyebrow: "Administração",
    description: "Crie departamentos e controle a quais cadernos seus membros podem acessar.",
    create: "Criar equipe",
    inheritedTitle: "O acesso de equipe é herdado",
    inheritedDesc: "Membros veem automaticamente os cadernos da sua equipe mais os compartilhados da empresa. O CEO e os administradores mantêm acesso a tudo.",
    archivedBadge: "Arquivada",
    edit: "Editar",
    membersNotebooks: "{{members}} membros · {{notebooks}} cadernos",
    managerLabel: "Gerente: {{name}}",
    noManager: "Sem gerente",
    empty: "Nenhuma equipe ainda.",
    createDialogTitle: "Criar equipe",
    createDialogDesc: "O slug identifica a equipe nas permissões e na classificação de conteúdo.",
    editDialogTitle: "Editar equipe",
    editDialogDesc: "As alterações são aplicadas imediatamente.",
    slugLabel: "Slug",
    slugPlaceholder: "ex.: juridico",
    slugHint: "Letras minúsculas, números, hífens e sublinhados. Não pode ser alterado depois.",
    nameLabel: "Nome",
    descriptionLabel: "Descrição",
    managerFieldLabel: "Gerente de equipe",
    activeLabel: "Equipe ativa",
    createDialogSubmit: "Criar equipe",
    createSuccess: "Equipe criada",
    updateSuccess: "Equipe atualizada",
  },
  migration: {
    eyebrow: "Administração",
    description: "Classifique notebooks e fontes existentes em equipes antes que os membros entrem. A passagem reconhece tokens nos nomes de arquivo (hr, finance, executive, company_shared) e define Company Shared como padrão para conteúdo não classificado.",
    runAction: "Executar classificação",
    runSuccess: "{{sources}} fontes e {{notebooks}} notebooks classificados ({{flagged}} sinalizados).",
    completedTitle: "Classificação concluída",
    completedDesc: "Todo o conteúdo existente está classificado. O login de membros está habilitado.",
    pendingTitle: "Classificação pendente",
    pendingDesc: "O login de membros permanece bloqueado até a conclusão da passagem e a resolução de todos os itens sinalizados.",
    flaggedSources: "Fontes sinalizadas",
    flaggedNotebooks: "Notebooks sinalizados",
    emptySection: "Nada para resolver aqui.",
    assignTeamLabel: "Equipe",
    assignTeamPlaceholder: "Selecione uma equipe",
    assignVisibilityLabel: "Visibilidade",
    visibilityTeam: "Equipe",
    visibilityCompanyShared: "Company Shared",
    assignAction: "Atribuir",
    assignSuccess: "Item atribuído a {{team}}.",
    linkedTeams: "Equipes vinculadas: {{teams}}",
    nothingFlagged: "Nada sinalizado. Execute a classificação para concluir.",
    reason: {
      ambiguous_tokens: "Tokens ambíguos",
      mixed_team_sources: "Fontes de equipes mistas",
      cross_team_link: "Vínculo entre equipes",
    },
  },
  ...
  sources: {
    ...
    cannotLinkAcrossTeams: "Fontes de outra equipe não podem ser adicionadas a este caderno.",
    hiddenOtherTeamSources: "{{count}} fonte(s) oculta(s) por pertencerem a uma equipe diferente deste caderno.",
  ...
  home: {
    welcomeTitle: "Pergunte qualquer coisa",
    welcomeHint: "Um chat para sua base de conhecimento e seus dados de negócio — o assistente escolhe a fonte certa para cada pergunta.",
    placeholder: "Pergunte sobre seus documentos ou seus dados…",
    suggestions: "Sugestões de acompanhamento",
    searching: "Buscando na base de conhecimento…",
    analysing: "Analisando dados de negócio…",
    answerSourceKnowledge: "Conhecimento",
    answerSourceAnalytics: "Análise",
    starterHighestSpender: "Quem gastou mais este ano?",
    starterRanking: "Ordene clientes por gasto total em 2026",
    starterTopServices: "Quais são nossos principais serviços?",
    starterKnowledgeBase: "Quais documentos estão na minha base de conhecimento?",
  },
  searchPage: {
    modeKnowledge: "Conhecimento",
    modeAnalytics: "Análise",
    analyticsModeGroup: "Modo de pergunta",
    analyticsTitle: "Pergunte aos dados do negócio",
    analyticsDesc: "As respostas vêm do banco de vendas estruturado, filtrado pelos conjuntos de dados permitidos para a sua equipe.",
    analyticsQuestion: "Pergunta",
    analyticsPlaceholder: "Ex.: Quem foi o maior comprador este ano?",
    analyticsIncludeRefunds: "Incluir reembolsos",
    analyticsAnalyse: "Analisar",
    analyticsAnalysing: "Analisando…",
    analyticsNoDatasets: "Você não tem acesso a nenhum conjunto de dados analítico. Contate um administrador se precisar de acesso.",
    analyticsError: "O serviço de análise não conseguiu responder. Tente novamente.",
    analyticsAnswerEyebrow: "Resposta analítica",
    analyticsBadgeLive: "Dados ao vivo · acesso filtrado",
    analyticsBadgeDenied: "Acesso negado",
    analyticsBadgeNoData: "Sem dados",
    analyticsBarsUnit: "MYR · no ano",
    analyticsViewQuery: "Ver consulta",
    analyticsFreshness: "dados até {{date}}",
    analyticsRefundsChip: "reembolsos {{refunds}}",
    analyticsHowCalculatedTitle: "Como foi calculado:",
    analyticsHowCalculated: "Agregações sobre transações concluídas agrupadas conforme exibido, com reembolsos e anulações excluídos, salvo indicação. Cada consulta é filtrada no servidor pelas equipes às quais você tem acesso.",
    analyticsDatasetLabel: "Conjunto de dados",
    analyticsStatusTitle: {
      ok: "Resposta analítica",
      denied: "Solicitação recusada",
      no_data: "Sem dados no período",
    },
    analyticsSuggestionHighestSpender: "Maior comprador",
    analyticsSuggestionRanking: "Ranking de clientes",
    analyticsSuggestionAverageTicket: "Ticket médio",
    analyticsSuggestionTopServices: "Serviços principais",
    askAndSearch: "Perguntar e Buscar",
  ...
  podcasts: {
    templateExplainerTitle: "Escolha um template, selecione fontes e clique em gerar",
    templateExplainerDesc: "Deep Dive percorre uma fonte em detalhes. Recap conecta as adições recentes a um notebook. A geração é enfileirada em segundo plano e leva alguns minutos.",
