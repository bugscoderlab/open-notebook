...
export const itIT = {
  ...
  auth: {
    ...
    migrationPending: "La migrazione dei contenuti è in corso — l'accesso dei membri è temporaneamente disabilitato. Contatta l'amministratore.",
    signingIn: "Accesso in corso...",
    signIn: "Accedi",
    devAccountsTitle: "Account di sviluppo (solo sviluppo)",
    devAccountsHint: "Fai clic su un account per compilare il modulo, poi premi Accedi",
  ...
  users: {
    ...
    description: "Invita persone, assegna il team e controlla lo stato dell'account.",
    invite: "Invita utente",
    statTotal: "Utenti totali",
    statActive: "Attivi",
    statInvited: "Inviti in attesa",
    statAllAccess: "Utenti con accesso completo",
    ...
    edit: "Modifica",
    accessAll: "Tutti i team",
    accessTeamCompany: "{{team}} + Azienda",
    lastActiveNow: "Adesso",
    lastActiveNever: "Mai",
    lastActiveMinutes: "{{count}} min fa",
    lastActiveHours: "{{count}} h fa",
    lastActiveDays: "{{count}} g fa",
    inviteDialogTitle: "Invita utente",
    inviteDialogDesc: "Accederanno con una password temporanea che condividi tu al di fuori del sistema. Nessuna email viene inviata.",
    emailLabel: "Email",
    ...
    tempPasswordPlaceholder: "Almeno 8 caratteri",
    tempPasswordHint: "Minimo 8 caratteri. Condividila con l'utente: non viene mai inviata via email.",
    inviteDialogSubmit: "Crea invito",
    inviteSuccess: "Invito creato: condividi la password temporanea con {{name}}.",
    editDialogTitle: "Modifica utente",
    updateSuccess: "Utente aggiornato",
    disableHint: "La disattivazione disconnette immediatamente l'utente e blocca gli accessi futuri.",
    resend: "Invia di nuovo",
    resendDialogTitle: "Reinvia invito",
    resendDialogDesc: "Imposta una nuova password temporanea e condividila con {{name}}. Nessuna email viene inviata.",
    resendDialogSubmit: "Reimposta la password dell'invito",
    role: {
      member: "Membro",
      team_manager: "Responsabile del team",
      ceo: "CEO",
  ...
  teams: {
    eyebrow: "Amministrazione",
    description: "Crea reparti e controlla a quali taccuini possono accedere i membri.",
    create: "Crea team",
    inheritedTitle: "L'accesso al team è ereditato",
    inheritedDesc: "I membri vedono automaticamente i taccuini del proprio team più quelli condivisi dell'azienda. CEO e amministratori mantengono accesso a tutto.",
    archivedBadge: "Archiviato",
    edit: "Modifica",
    membersNotebooks: "{{members}} membri · {{notebooks}} taccuini",
    managerLabel: "Responsabile: {{name}}",
    noManager: "Nessun responsabile",
    empty: "Nessun team ancora.",
    createDialogTitle: "Crea team",
    createDialogDesc: "Lo slug identifica il team nei permessi e nella classificazione dei contenuti.",
    editDialogTitle: "Modifica team",
    editDialogDesc: "Le modifiche vengono applicate immediatamente.",
    slugLabel: "Slug",
    slugPlaceholder: "ad es. legal",
    slugHint: "Lettere minuscole, numeri, trattini e underscore. Non può essere modificato in seguito.",
    nameLabel: "Nome",
    descriptionLabel: "Descrizione",
    managerFieldLabel: "Responsabile del team",
    activeLabel: "Il team è attivo",
    createDialogSubmit: "Crea team",
    createSuccess: "Team creato",
    updateSuccess: "Team aggiornato",
  },
  migration: {
    eyebrow: "Amministrazione",
    description: "Classifica i notebook e le fonti esistenti nelle squadre prima che i membri accedano. Il passaggio riconosce i token nei nomi dei file (hr, finance, executive, company_shared) e imposta Company Shared come predefinito per i contenuti non classificati.",
    runAction: "Esegui classificazione",
    runSuccess: "{{sources}} fonti e {{notebooks}} notebook classificati ({{flagged}} segnalati).",
    completedTitle: "Classificazione completata",
    completedDesc: "Tutti i contenuti esistenti sono classificati. L'accesso dei membri è abilitato.",
    pendingTitle: "Classificazione in sospeso",
    pendingDesc: "L'accesso dei membri rimane bloccato finché il passaggio non è completo e ogni elemento segnalato è risolto.",
    flaggedSources: "Fonti segnalate",
    flaggedNotebooks: "Notebook segnalati",
    emptySection: "Niente da risolvere qui.",
    assignTeamLabel: "Squadra",
    assignTeamPlaceholder: "Seleziona una squadra",
    assignVisibilityLabel: "Visibilità",
    visibilityTeam: "Squadra",
    visibilityCompanyShared: "Company Shared",
    assignAction: "Assegna",
    assignSuccess: "Elemento assegnato a {{team}}.",
    linkedTeams: "Squadre collegate: {{teams}}",
    nothingFlagged: "Niente di segnalato. Esegui la classificazione per completare.",
    reason: {
      ambiguous_tokens: "Token ambigui",
      mixed_team_sources: "Fonti di squadre miste",
      cross_team_link: "Collegamento tra squadre",
    },
  },
  ...
  sources: {
    ...
    cannotLinkAcrossTeams: "Le fonti di un altro team non possono essere aggiunte a questo notebook.",
    hiddenOtherTeamSources: "{{count}} fonte(i) nascoste perché appartengono a un team diverso da questo notebook.",
  ...
  home: {
    welcomeTitle: "Chiedi quello che vuoi",
    welcomeHint: "Una chat per la tua knowledge base e i tuoi dati aziendali: l'assistente sceglie la fonte giusta per ogni domanda.",
    placeholder: "Chiedi sui tuoi documenti o sui tuoi dati…",
    suggestions: "Possibili approfondimenti",
    searching: "Ricerca nella knowledge base…",
    analysing: "Analisi dei dati aziendali…",
    answerSourceKnowledge: "Conoscenza",
    answerSourceAnalytics: "Analitica",
    starterHighestSpender: "Chi ha speso di più quest'anno?",
    starterRanking: "Classifica i clienti per spesa totale nel 2026",
    starterTopServices: "Quali sono i nostri servizi principali?",
    starterKnowledgeBase: "Quali documenti ci sono nella mia knowledge base?",
  },
  searchPage: {
    modeKnowledge: "Conoscenza",
    modeAnalytics: "Analisi",
    analyticsModeGroup: "Modalità domanda",
    analyticsTitle: "Interroga i dati aziendali",
    analyticsDesc: "Le risposte provengono dal database delle vendite strutturato, filtrato in base ai dataset consentiti alla tua squadra.",
    analyticsQuestion: "Domanda",
    analyticsPlaceholder: "Es.: Chi è il cliente che spende di più quest'anno?",
    analyticsIncludeRefunds: "Includi rimborsi",
    analyticsAnalyse: "Analizza",
    analyticsAnalysing: "Analisi…",
    analyticsNoDatasets: "Non hai accesso ad alcun dataset analitico. Contatta un amministratore se ti serve accesso.",
    analyticsError: "Il servizio di analisi non ha potuto rispondere. Riprova.",
    analyticsAnswerEyebrow: "Risposta analitica",
    analyticsBadgeLive: "Dati live · accesso filtrato",
    analyticsBadgeDenied: "Accesso negato",
    analyticsBadgeNoData: "Nessun dato",
    analyticsBarsUnit: "MYR · anno in corso",
    analyticsViewQuery: "Vista query",
    analyticsFreshness: "dati fino al {{date}}",
    analyticsRefundsChip: "rimborsi {{refunds}}",
    analyticsHowCalculatedTitle: "Come è stato calcolato:",
    analyticsHowCalculated: "Aggregazioni sulle transazioni completate raggruppate come mostrato, con rimborsi e annullamenti esclusi salvo indicazione. Ogni query è filtrata lato server in base alle squadre a cui hai accesso.",
    analyticsDatasetLabel: "Dataset",
    analyticsStatusTitle: {
      ok: "Risposta analitica",
      denied: "Richiesta rifiutata",
      no_data: "Nessun dato per il periodo",
    },
    analyticsSuggestionHighestSpender: "Migliore cliente",
    analyticsSuggestionRanking: "Classifica clienti",
    analyticsSuggestionAverageTicket: "Valore medio",
    analyticsSuggestionTopServices: "Servizi principali",
    askAndSearch: "Chiedi e cerca",
  ...
  podcasts: {
    templateExplainerTitle: "Scegli un modello, seleziona le fonti e premi genera",
    templateExplainerDesc: "Deep Dive analizza una fonte in dettaglio. Recap collega le ultime aggiunte a un notebook. La generazione avviene in background e richiede alcuni minuti.",
