...
export const ruRU = {
  ...
  auth: {
    ...
    migrationPending: "Идёт миграция контента — вход для участников временно отключён. Обратитесь к администратору.",
    signingIn: "Вход...",
    signIn: "Войти",
    devAccountsTitle: "Dev-аккаунты (только для разработки)",
    devAccountsHint: "Нажмите на аккаунт, чтобы заполнить форму, затем нажмите «Войти»",
  ...
  users: {
    ...
    description: "Приглашайте людей, назначайте команды и управляйте статусом аккаунтов.",
    invite: "Пригласить пользователя",
    statTotal: "Всего пользователей",
    statActive: "Активные",
    statInvited: "Ожидающие приглашения",
    statAllAccess: "Пользователи с полным доступом",
    searchPlaceholder: "Поиск по имени или почте…",
    filterAllTeams: "Все команды",
    ...
    empty: "Нет пользователей, соответствующих фильтрам.",
    edit: "Изменить",
    accessAll: "Все команды",
    accessTeamCompany: "{{team}} + Общие",
    lastActiveNow: "Сейчас",
    lastActiveNever: "Никогда",
    lastActiveMinutes: "{{count}} мин назад",
    lastActiveHours: "{{count}} ч назад",
    lastActiveDays: "{{count}} дн назад",
    inviteDialogTitle: "Пригласить пользователя",
    inviteDialogDesc: "Пользователь войдёт с временным паролем, которым вы поделитесь с ним отдельно. Письмо не отправляется.",
    emailLabel: "Эл. почта",
    ...
    tempPasswordPlaceholder: "Не менее 8 символов",
    tempPasswordHint: "Минимум 8 символов. Передайте его пользователю — по почте он не отправляется.",
    inviteDialogSubmit: "Создать приглашение",
    inviteSuccess: "Приглашение создано — передайте временный пароль пользователю {{name}}.",
    editDialogTitle: "Изменить пользователя",
    updateSuccess: "Пользователь обновлён",
    disableHint: "При отключении пользователь немедленно выйдет из системы, а вход будет заблокирован.",
    resend: "Отправить снова",
    resendDialogTitle: "Повторить приглашение",
    resendDialogDesc: "Задайте новый временный пароль и передайте его пользователю {{name}}. Письмо не отправляется.",
    resendDialogSubmit: "Сбросить пароль приглашения",
    role: {
      member: "Участник",
  ...
  teams: {
    eyebrow: "Администрирование",
    description: "Создавайте отделы и управляйте доступом к блокнотам их участников.",
    create: "Создать команду",
    inheritedTitle: "Доступ команды наследуется",
    inheritedDesc: "Участники автоматически видят блокноты своей команды и общие материалы компании. CEO и администраторы сохраняют доступ ко всему.",
    archivedBadge: "В архиве",
    edit: "Изменить",
    membersNotebooks: "{{members}} участников · {{notebooks}} блокнотов",
    managerLabel: "Руководитель: {{name}}",
    noManager: "Без руководителя",
    empty: "Команд пока нет.",
    createDialogTitle: "Создать команду",
    createDialogDesc: "Слаг идентифицирует команду в разрешениях и классификации контента.",
    editDialogTitle: "Изменить команду",
    editDialogDesc: "Изменения применяются немедленно.",
    slugLabel: "Слаг",
    slugPlaceholder: "напр. legal",
    slugHint: "Строчные буквы, цифры, дефисы и подчёркивания. Нельзя изменить позже.",
    nameLabel: "Название",
    descriptionLabel: "Описание",
    managerFieldLabel: "Руководитель команды",
    activeLabel: "Команда активна",
    createDialogSubmit: "Создать команду",
    createSuccess: "Команда создана",
    updateSuccess: "Команда обновлена",
  },
  migration: {
    eyebrow: "Администрирование",
    description: "Распределите существующие блокноты и источники по командам до входа участников. Проход распознаёт токены в именах файлов (hr, finance, executive, company_shared), а неклассифицированный контент по умолчанию становится Company Shared.",
    runAction: "Запустить классификацию",
    runSuccess: "Классифицировано источников: {{sources}}, блокнотов: {{notebooks}} (отмечено: {{flagged}}).",
    completedTitle: "Классификация завершена",
    completedDesc: "Весь существующий контент классифицирован. Вход для участников включён.",
    pendingTitle: "Классификация ожидает",
    pendingDesc: "Вход для участников заблокирован, пока проход не завершится и все отмеченные элементы не будут разрешены.",
    flaggedSources: "Отмеченные источники",
    flaggedNotebooks: "Отмеченные блокноты",
    emptySection: "Здесь нечего решать.",
    assignTeamLabel: "Команда",
    assignTeamPlaceholder: "Выберите команду",
    assignVisibilityLabel: "Видимость",
    visibilityTeam: "Команда",
    visibilityCompanyShared: "Company Shared",
    assignAction: "Назначить",
    assignSuccess: "Элемент назначен команде {{team}}.",
    linkedTeams: "Связанные команды: {{teams}}",
    nothingFlagged: "Ничего не отмечено. Запустите классификацию для завершения.",
    reason: {
      ambiguous_tokens: "Неоднозначные токены",
      mixed_team_sources: "Источники разных команд",
      cross_team_link: "Связь между командами",
    },
  },
  ...
  sources: {
    ...
    cannotLinkAcrossTeams: "Источники другой команды нельзя добавить в этот блокнот.",
    hiddenOtherTeamSources: "Скрыто источников: {{count}} — они принадлежат другой команде, чем этот блокнот.",
  ...
  home: {
    ...
    welcomeHint: "Один чат для базы знаний и бизнес-данных — ассистент выбирает правильный источник для каждого вопроса.",
    placeholder: "Спросите о документах или данных…",
    suggestions: "Возможные уточнения",
    searching: "Поиск по базе знаний…",
    analysing: "Анализ бизнес-данных…",
    answerSourceKnowledge: "Знания",
    answerSourceAnalytics: "Аналитика",
    starterHighestSpender: "Кто больше всего потратил в этом году?",
    starterRanking: "Ранжируйте клиентов по общим расходам за 2026 год",
    starterTopServices: "Какие у нас основные услуги?",
    starterKnowledgeBase: "Какие документы есть в моей базе знаний?",
  },
  searchPage: {
    modeKnowledge: "Знания",
    modeAnalytics: "Аналитика",
    analyticsModeGroup: "Режим вопроса",
    analyticsTitle: "Спросите бизнес-данные",
    analyticsDesc: "Ответы берутся из структурированной базы продаж и фильтруются по наборам данных, разрешённым вашей команде.",
    analyticsQuestion: "Вопрос",
    analyticsPlaceholder: "Напр.: Кто больше всех потратил в этом году?",
    analyticsIncludeRefunds: "Включить возвраты",
    analyticsAnalyse: "Анализировать",
    analyticsAnalysing: "Анализ…",
    analyticsNoDatasets: "У вас нет доступа ни к одному аналитическому набору данных. Обратитесь к администратору.",
    analyticsError: "Аналитический сервис не смог ответить. Попробуйте снова.",
    analyticsAnswerEyebrow: "Аналитический ответ",
    analyticsBadgeLive: "Живые данные · доступ отфильтрован",
    analyticsBadgeDenied: "Доступ запрещён",
    analyticsBadgeNoData: "Нет данных",
    analyticsBarsUnit: "MYR · с начала года",
    analyticsViewQuery: "Показать запрос",
    analyticsFreshness: "данные до {{date}}",
    analyticsRefundsChip: "возвраты {{refunds}}",
    analyticsHowCalculatedTitle: "Как это было вычислено:",
    analyticsHowCalculated: "Агрегации завершённых транзакций, сгруппированные как показано; возвраты и аннулирования исключены, если не указано иное. Каждый запрос фильтруется на сервере по командам, к которым у вас есть доступ.",
    analyticsDatasetLabel: "Набор данных",
    analyticsStatusTitle: {
      ok: "Аналитический ответ",
      denied: "Запрос отклонён",
      no_data: "Нет данных за период",
    },
    analyticsSuggestionHighestSpender: "Топ-клиент",
    analyticsSuggestionRanking: "Рейтинг клиентов",
    analyticsSuggestionAverageTicket: "Средний чек",
    analyticsSuggestionTopServices: "Основные услуги",
    askAndSearch: "Запрос и поиск",
  ...
  podcasts: {
    templateExplainerTitle: "Выберите шаблон, выберите источники и нажмите «Создать»",
    templateExplainerDesc: "Deep Dive подробно разбирает один источник. Recap связывает последние добавления с блокнотом. Генерация ставится в очередь в фоне и занимает несколько минут.",
