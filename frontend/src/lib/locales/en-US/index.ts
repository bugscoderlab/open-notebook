export const enUS = {
  ...
  auth: {
    ...
    signIn: "Sign In",
    devAccountsTitle: "Dev accounts (dev only)",
    devAccountsHint: "Click an account to fill the form, then press Sign In",
  ...
  users: {
    ...
    description: "Invite people, assign their team and control account status.",
    invite: "Invite user",
    statTotal: "Total users",
    statActive: "Active",
    statInvited: "Pending invites",
    statAllAccess: "All-access users",
    ...
    edit: "Edit",
    accessAll: "All teams",
    accessTeamCompany: "{{team}} + Company",
    lastActiveNow: "Now",
    lastActiveNever: "Never",
    lastActiveMinutes: "{{count}} min ago",
    lastActiveHours: "{{count}} h ago",
    lastActiveDays: "{{count}} d ago",
    inviteDialogTitle: "Invite user",
    inviteDialogDesc:
      "They sign in with a temporary password that you share with them out-of-band. No email is sent.",
    emailLabel: "Email",
    ...
    tempPasswordHint:
      "Minimum 8 characters. Share it with the user — it is never emailed.",
    inviteDialogSubmit: "Create invite",
    inviteSuccess:
      "Invitation created — share the temporary password with {{name}}.",
    editDialogTitle: "Edit user",
    updateSuccess: "User updated",
    disableHint:
      "Disabling signs the user out immediately and blocks future sign-ins.",
    resend: "Resend",
    resendDialogTitle: "Resend invite",
    resendDialogDesc: "Set a new temporary password and share it with {{name}}. No email is sent.",
    resendDialogSubmit: "Reset invite password",
    role: {
      member: "Member",
  ...
  teams: {
    eyebrow: "Administration",
    description:
      "Create departments and control which notebooks their members can access.",
    create: "Create team",
    inheritedTitle: "Team access is inherited",
    inheritedDesc:
      "Members automatically see their team notebooks plus Company Shared. The CEO and admins retain access to everything.",
    archivedBadge: "Archived",
    edit: "Edit",
    membersNotebooks: "{{members}} members · {{notebooks}} notebooks",
    managerLabel: "Manager: {{name}}",
    noManager: "No manager",
    empty: "No teams yet.",
    createDialogTitle: "Create team",
    createDialogDesc:
      "The slug identifies the team in permissions and content classification.",
    editDialogTitle: "Edit team",
    editDialogDesc: "Changes apply immediately.",
    slugLabel: "Slug",
    slugPlaceholder: "e.g. legal",
    slugHint:
      "Lowercase letters, numbers, dashes and underscores. Cannot be changed later.",
    nameLabel: "Name",
    descriptionLabel: "Description",
    managerFieldLabel: "Team manager",
    activeLabel: "Team is active",
  ...
  sources: {
    ...
    catalogDesc: "Everything you have collected, across all notebooks.",
    sortBy: "Sort by",
    ...
    cannotLinkAcrossTeams: "Sources from a different team can't be added to this notebook.",
    hiddenOtherTeamSources: "{{count}} source(s) hidden because they belong to a different team than this notebook.",
  ...
  home: {
    ...
    starterHighestSpender: "Who is the highest spender this year?",
    starterRanking: "Rank customers by total spend in 2026",
    starterTopServices: "What are our top services?",
    starterKnowledgeBase: "What documents are in my knowledge base?",
  },
  searchPage: {
    askAndSearch: "Ask and Search",
  ...
  podcasts: {
    templateExplainerTitle: "Pick a template, choose sources, press generate",
    templateExplainerDesc: "Deep Dive walks through one source in detail. Recap connects the latest additions to a notebook. Generation is queued in the background and takes a few minutes.",
  ...
  settings: {
    ...
    askPipelineDesc: "Tune how the Ask pipeline spends model calls per question",
    askMaxSearches: "Max searches per question",
    askMaxSearchesHelp: "Each search runs its own model call over the retrieved chunks, so more searches cost more. 3 covers most questions.",
    askSearchAnswerMaxTokens: "Search answer token budget",
    askSearchAnswerMaxTokensHelp: "Output limit for each intermediate search answer that feeds the final synthesis. Lower values conserve credits; the final answer's larger budget is unaffected.",
  ...
  chatIntegrations: {
    ...
    description: "Ask questions and search your notebooks from Telegram or WhatsApp.",
    platforms: {
      telegram: "Telegram",
      whatsapp: "WhatsApp",
    },
    ...
    linkedCount: "{{count}} linked identity(ies)",
    notConnectedDesc: "Link your {{platform}} account to ask from chat",
    connect: "Connect",
    manage: "Manage",
    close: "Close",
    connectTitle: "Connect {{platform}}",
    connectDesc: "You'll confirm the link from your phone — takes under a minute.",
    stepSend: "Open {{platform}} and send the code to {{bot}}:",
    stepWait: "Wait here — we confirm automatically.",
    codeExpired: "This code expired. Generate a new one — your connection is unaffected.",
    ...
    unlink: "Unlink",
    unlinkSuccess: "Integration link removed",
    linkedSuccess: "Chat account linked — you can start asking questions",
    createFailed: "Could not create a linking code, try again",
    telegramBotRef: "@open_notebook_bot",
    whatsappBotRef: "the Open Notebook number",
    whatsappStepScan: "In WhatsApp, go to Settings → Linked devices → Link a device and scan the QR below",
    whatsappQrRefreshNote: "The QR refreshes automatically until it expires.",
    whatsappQrConnected: "WhatsApp is connected — now send the code below to link your account.",
    whatsappQrWaiting: "Waiting for a pairing QR from the gateway — make sure the messenger gateway is running.",
    whatsappLinkSelf: "This is my number — link it to my account",
    whatsappRePair: "Re-pair with a different number",
  },
  advanced: {
    title: "AdvancedTools",
