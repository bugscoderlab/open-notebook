...
export const zhTW = {
  ...
  searchPage: {
    modeKnowledge: "知識",
    modeAnalytics: "分析",
    analyticsModeGroup: "提問模式",
    analyticsTitle: "詢問業務資料",
    analyticsDesc: "回答來自結構化的銷售資料庫，並過濾為您團隊有權存取的資料集。",
    analyticsQuestion: "問題",
    analyticsPlaceholder: "例如：今年消費最高的客戶是誰？",
    analyticsIncludeRefunds: "包含退款",
    analyticsAnalyse: "分析",
    analyticsAnalysing: "分析中…",
    analyticsNoDatasets: "您沒有任何分析資料集的存取權限。如有需要，請聯絡管理員。",
    analyticsError: "分析服務無法回答，請重試。",
    analyticsAnswerEyebrow: "分析回答",
    analyticsBadgeLive: "即時資料 · 已依權限過濾",
    analyticsBadgeDenied: "存取被拒絕",
    analyticsBadgeNoData: "無資料",
    analyticsBarsUnit: "MYR · 年初至今",
    analyticsViewQuery: "查看查詢",
    analyticsFreshness: "資料截至 {{date}}",
    analyticsRefundsChip: "退款 {{refunds}}",
    analyticsHowCalculatedTitle: "計算方式：",
    analyticsHowCalculated: "對已完成交易依所示方式彙總，除特別說明外均排除退款和作廢記錄。所有查詢均在伺服器端依您有權存取的團隊進濾。",
    analyticsDatasetLabel: "資料集",
    analyticsStatusTitle: {
      ok: "分析回答",
      denied: "請求被拒絕",
      no_data: "該期間沒有資料",
    },
    analyticsSuggestionHighestSpender: "最高消費客戶",
    analyticsSuggestionRanking: "客戶排名",
    analyticsSuggestionAverageTicket: "平均客單價",
    analyticsSuggestionTopServices: "主要服務",
    askAndSearch: "提問與搜尋",
    chooseAMode: "選擇模式",
    askBeta: "提問 (beta)",
    search: "搜尋",
