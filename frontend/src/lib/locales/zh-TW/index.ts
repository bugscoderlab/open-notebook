...
export const zhTW = {
  ...
  auth: {
    ...
    migrationPending: "內容遷移正在進行中，成員登入已暫時停用。請聯絡管理員。",
    signingIn: "正在登入...",
    signIn: "登入",
    devAccountsTitle: "開發帳號（僅限開發）",
    devAccountsHint: "點擊帳號填入表單，然後按登入",
  ...
  users: {
    eyebrow: "管理",
    description: "邀請成員、指派團隊並管理帳號狀態。",
    invite: "邀請使用者",
    statTotal: "使用者總數",
    statActive: "使用中",
    statInvited: "待處理邀請",
    statAllAccess: "全存取權限使用者",
    ...
    edit: "編輯",
    accessAll: "所有團隊",
    accessTeamCompany: "{{team}} + 公司共用",
    lastActiveNow: "剛剛",
    lastActiveNever: "從未",
    lastActiveMinutes: "{{count}} 分鐘前",
    lastActiveHours: "{{count}} 小時前",
    lastActiveDays: "{{count}} 天前",
    inviteDialogTitle: "邀請使用者",
    inviteDialogDesc: "使用者將以您另外共用的臨時密碼登入。系統不會傳送任何電子郵件。",
    emailLabel: "電子郵件",
    ...
    roleLabel: "角色",
    statusLabel: "狀態",
    tempPasswordLabel: "臨時密碼",
    tempPasswordPlaceholder: "至少 8 個字元",
    tempPasswordHint: "至少 8 個字元。請與使用者共用——系統不會透過電子郵件傳送。",
    inviteDialogSubmit: "建立邀請",
    inviteSuccess: "邀請已建立——請與 {{name}} 共用臨時密碼。",
    editDialogTitle: "編輯使用者",
    updateSuccess: "使用者已更新",
    disableHint: "停用後該使用者將立即登出，且之後無法再登入。",
    resend: "重發",
    resendDialogTitle: "重發邀請",
    resendDialogDesc: "設定新的臨時密碼並與 {{name}} 共用。系統不會傳送任何電子郵件。",
    resendDialogSubmit: "重設邀請密碼",
    role: {
      member: "成員",
      team_manager: "團隊經理",
      ceo: "CEO",
  ...
  teams: {
    eyebrow: "管理",
    description: "建立部門，並控制其成員可以存取哪些筆記本。",
    create: "建立團隊",
    inheritedTitle: "團隊存取權限自動繼承",
    inheritedDesc: "成員自動可見其所屬團隊的筆記本及公司共用內容。CEO 與管理員保留對所有內容的存取權限。",
    archivedBadge: "已封存",
    edit: "編輯",
    membersNotebooks: "{{members}} 位成員 · {{notebooks}} 本筆記本",
    managerLabel: "經理：{{name}}",
    noManager: "無經理",
    empty: "還沒有團隊。",
    createDialogTitle: "建立團隊",
    createDialogDesc: "Slug 用於在權限和內容分類中識別團隊。",
    editDialogTitle: "編輯團隊",
    editDialogDesc: "變更將立即生效。",
    slugLabel: "Slug",
    slugPlaceholder: "例如 legal",
    slugHint: "小寫字母、數字、連字號和底線。建立後無法變更。",
    nameLabel: "名稱",
    descriptionLabel: "描述",
    managerFieldLabel: "團隊經理",
    activeLabel: "團隊為啟用狀態",
    createDialogSubmit: "建立團隊",
    createSuccess: "團隊已建立",
    updateSuccess: "團隊已更新",
  },
  migration: {
    eyebrow: "管理",
    description: "在成員登入之前，將現有筆記本和來源分類到團隊。分類程序會識別檔名中的標記（hr、finance、executive、company_shared），未分類的內容預設為 Company Shared。",
    runAction: "執行分類",
    runSuccess: "已分類 {{sources}} 個來源和 {{notebooks}} 個筆記本（{{flagged}} 個被標記）。",
    completedTitle: "分類已完成",
    completedDesc: "所有現有內容均已分類。成員登入已啟用。",
    pendingTitle: "分類待處理",
    pendingDesc: "在分類完成且所有標記項目解決之前，成員登入將保持封鎖狀態。",
    flaggedSources: "被標記的來源",
    flaggedNotebooks: "被標記的筆記本",
    emptySection: "這裡沒有需要處理的內容。",
    assignTeamLabel: "團隊",
    assignTeamPlaceholder: "選擇團隊",
    assignVisibilityLabel: "可見性",
    visibilityTeam: "團隊",
    visibilityCompanyShared: "Company Shared",
    assignAction: "指派",
    assignSuccess: "項目已指派給 {{team}}。",
    linkedTeams: "關聯團隊：{{teams}}",
    nothingFlagged: "沒有標記的項目。執行分類以完成。",
    reason: {
      ambiguous_tokens: "標記不明確",
      mixed_team_sources: "混合團隊的來源",
      cross_team_link: "跨團隊連結",
    },
  },
  ...
  sources: {
    ...
    cannotLinkAcrossTeams: "無法將其他團隊的來源新增到此筆記本。",
    hiddenOtherTeamSources: "已隱藏 {{count}} 個來源，因為它們屬於與此筆記本不同的團隊。",
  ...
  home: {
    ...
    suggestions: "建議的追問",
    searching: "正在搜尋知識庫…",
    answerSourceKnowledge: "知識",
    starterHighestSpender: "今年消費最高的是誰？",
    starterRanking: "依 2026 年總消費幫客戶排名",
    starterTopServices: "我們的主要服務有哪些？",
    starterKnowledgeBase: "我的知識庫裡有哪些文件？",
  },
  searchPage: {
    askAndSearch: "提問與搜尋",
    chooseAMode: "選擇模式",
  ...
  podcasts: {
    templateExplainerTitle: "選擇範本、選擇來源，然後按產生",
    templateExplainerDesc: "Deep Dive 詳細講解一個來源。Recap 將最新新增的內容連結到筆記本。產生在背景排隊，需要幾分鐘。",
  ...
  settings: {
    ...
    askPipeline: "Ask 管線",
    askPipelineDesc: "調整 Ask 管線每個問題的模型呼叫開銷",
    askMaxSearches: "每個問題的最大搜尋次數",
    askMaxSearchesHelp: "每次搜尋都會對檢索到的內容區塊單獨呼叫一次模型，搜尋越多花費越高。3 次已能涵蓋大多數問題。",
    askSearchAnswerMaxTokens: "搜尋答案 Token 上限",
    askSearchAnswerMaxTokensHelp: "每條用於最終彙總的中間搜尋答案的輸出上限。調低可節省額度；最終答案的更大預算不受影響。",
    fileManagement: "檔案管理",
  ...
  chatIntegrations: {
    title: "聊天整合",
    description: "透過 Telegram 或 WhatsApp 提問並搜尋您的筆記本。",
    platforms: {
      telegram: "Telegram",
      whatsapp: "WhatsApp",
    },
    connected: "已連線",
    notConnected: "未連線",
    linkedCount: "已綁定 {{count}} 個身份",
    notConnectedDesc: "綁定您的 {{platform}} 帳戶以在聊天中提問",
    connect: "連線",
    manage: "管理",
    close: "關閉",
    connectTitle: "連線 {{platform}}",
    connectDesc: "您需要在手機上確認綁定——一分鐘內即可完成。",
    stepSend: "開啟 {{platform}}，將驗證碼傳送給 {{bot}}：",
    stepWait: "請稍候——系統會自動確認。",
    codeExpired: "驗證碼已過期。重新產生一個即可——連線不受影響。",
    generateNew: "產生新驗證碼",
    expiresIn: "{{time}} 後過期",
    waiting: "等待確認…",
    copied: "複製驗證碼",
    linkedOn: "綁定於 {{date}}",
    unlink: "解除綁定",
    unlinkSuccess: "整合綁定已移除",
    linkedSuccess: "聊天帳戶已綁定——您可以開始提問了",
    createFailed: "無法產生驗證碼，請重試",
    telegramBotRef: "@open_notebook_bot",
    whatsappBotRef: "Open Notebook 號碼",
    whatsappStepScan: "在 WhatsApp 中，前往 設定 → 已連結的裝置 → 連結裝置，掃描下方 QR 碼",
    whatsappQrRefreshNote: "QR 碼會自動重新整理，直至過期。",
    whatsappQrConnected: "WhatsApp 已連線——請傳送下方代碼以綁定您的帳戶。",
    whatsappQrWaiting: "正在等待閘道傳回配對 QR 碼——請確認 messenger 閘道正在運作。",
    whatsappLinkSelf: "這是我本人的號碼——綁定到我的帳戶",
    whatsappRePair: "改用其他號碼配對",
  },
  advanced: {
    title: "進階工具",
